...
function defaultData() {
    return {
        blocked: [],          // follow/react නවත්තපු users
        totalUsers: [],       // pair කරපු හැම user
        followCount: {},      // user -> follow කරාද
        reactCount: {},       // user -> react කරාද
        stats: {
            totalFollows: 0,
            totalReacts: 0
        }
